...
export default function WhyIndependent() {
  return (
    <section className="relative overflow-hidden py-24">
      {/* Fades this section's bottom into the CTA section's black top, so
          the two blend into each other instead of meeting at a hard line. */}
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 bottom-0 h-44 bg-linear-to-t from-black to-transparent"
      />
